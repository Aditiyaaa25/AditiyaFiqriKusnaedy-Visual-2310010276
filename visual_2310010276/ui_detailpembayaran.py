...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tabelPembayaran.setGeometry(QRect(140, 300, 511, 192))
    ...
    def retranslateUi(self, Form):
        ...
        ___qtablewidgetitem1.setText(QCoreApplication.translate("Form", u"ID Pembayaran", None));
        ___qtablewidgetitem2 = self.tabelPembayaran.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("Form", u"ID Transaksi", None));
